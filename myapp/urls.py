...
urlpatterns = [
    ...
    path('new-student-list/', views.new_student_list, name='new_student_list'),
    path('students/<int:student_id>/view/', views.view_student_details, name='view_student_details'),
    path('update-registration/<int:registration_id>/', views.update_registration, name='update_registration'),
    path('confirm-delete-registration/<int:registration_id>/', views.confirm_delete_registration, name='confirm_delete_registration'),
